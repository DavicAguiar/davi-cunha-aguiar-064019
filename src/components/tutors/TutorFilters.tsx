...
export const TutorFilters: React.FC<TutorFiltersProps> = ({ filters }) => {
  ...
  const labelCls = "text-[10px] font-black uppercase ml-2 tracking-tighter text-[color:var(--nav-muted-2)]";

  const inputCls = "px-5 py-3.5 rounded-2xl outline-none transition-all font-semibold " +
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-10 p-6 rounded-[2rem] items-end
      bg-[color:var(--nav-bg)] border border-[color:var(--nav-border)]"
    >
