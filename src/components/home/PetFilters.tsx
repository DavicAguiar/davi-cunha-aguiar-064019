...
export const PetFilters: React.FC<PetFiltersProps> = ({ filters }) => {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-10 p-6 bg-slate-50 rounded-[2rem] border border-slate-100 items-end">
      ...
      <div className="md:col-span-5 flex flex-col gap-1.5">
        ...
        <input 
          ...
          className="px-5 py-3.5 bg-white border-none rounded-2xl shadow-sm focus:ring-2 focus:ring-violet-500 outline-none transition-all"
          value={localRaca}
      ...
      <div className="md:col-span-2">
        <button 
          ...
          className="w-full h-[54px] bg-slate-900 text-white rounded-2xl flex items-center justify-center gap-2 hover:bg-emerald-600 transition-all active:scale-95 shadow-lg"
        >
