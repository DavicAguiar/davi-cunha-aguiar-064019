    ...
    return (
        ...
        <div className="flex items-end justify-between gap-3">
            ...
            <button
                type="button"
                onClick={loadLinked}
                className="px-4 py-2 cursor-pointer rounded-xl bg-white border border-slate-200 text-[10px] font-black uppercase tracking-widest text-slate-600 hover:border-emerald-500 hover:text-emerald-600"
                >
                Atualizar
            </button>
        </div>
        ...
        <div className="rounded-3xl border border-slate-100 p-5">
                ...
                {loadingAvail ? (
                    ...
                    return (
                        ...
                        {isLinked ? (
                            ...
                            <span className="px-3 py-2 rounded-xl bg-slate-100 text-slate-500 text-[10px] font-black uppercase tracking-widest">
                                Já vinculado
                            </span>
                            ...
                            <button
                                ...
                                className="px-3 py-2 rounded-xl bg-emerald-600 text-white
                                 text-[10px] font-black uppercase tracking-widest opacity-40 cursor-not-allowed flex
                                  items-center gap-2"
                            ...
                            className="px-3 py-2 rounded-xl cursor-pointer bg-emerald-600 text-white text-[10px] font-black uppercase tracking-widest hover:bg-emerald-700 disabled:opacity-50 flex items-center gap-2"
                            >
            ...
            <div className="mt-4 flex items-center justify-between">
                <button
                    ...
                    className="px-3 py-2 rounded-xl bg-white border border-slate-200 text-[10px] font-black uppercase tracking-widest text-slate-600 disabled:opacity-40 enabled:cursor-pointer disabled:cursor-not-allowed"
                >
                    Anterior
                </button>
                ...
                <button
                    type="button"
                    onClick={() => loadAvailable(search.trim(), safeNext)}
                    disabled={loadingAvail || pageCount === 0 || page >= pageCount - 1}
                    className="px-3 py-2 enabled:cursor-pointer disabled:cursor-not-allowed rounded-xl bg-white border border-slate-200 text-[10px] font-black uppercase tracking-widest text-slate-600 disabled:opacity-40"
                >
                    Próxima
                </button>
            </div>
            ...
            <div className="space-y-2">
                ...
                <Row key={p.id} pet={p} onView={() => onViewPet(p)}>
                    <button
                        ...
                        disabled={busyId === p.id}
                        className="w-10 h-10 rounded-xl cursor-pointer bg-white border border-slate-200 text-slate-500 hover:border-red-200 hover:text-red-600 disabled:opacity-50 flex items-center justify-center"
